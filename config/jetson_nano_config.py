...
class JetsonNanoConfig:
    ...
    def from_env(cls) -> "JetsonNanoConfig":
        ...
        return cls(
            ...
            normalize_embeddings=os.getenv("JETSON_NORMALIZE", "true").lower() == "true",
            use_half_precision=os.getenv("JETSON_HALF_PRECISION", "false").lower() == "true",
            max_memory_usage=os.getenv("JETSON_MAX_MEMORY", "2GB"),
            enable_memory_optimization=os.getenv("JETSON_MEMORY_OPT", "true").lower() == "true",
            mcp_host=os.getenv("MCP_HOST", "0.0.0.0"),
            mcp_port=int(os.getenv("MCP_PORT", "8000")),
            enable_health_check=os.getenv("JETSON_HEALTH_CHECK", "true").lower() == "true",
            ...
            chroma_persist_directory=os.getenv("JETSON_CHROMA_DIR", "/opt/pyrag/data/chroma"),
            enable_persistence=os.getenv("JETSON_ENABLE_PERSISTENCE", "true").lower() == "true",
