...
from pyrag.search import QueryAnalyzer, EnhancedSearchEngine, QueryAnalysis
...
class TestQueryAnalyzer:
    ...
    def test_extract_library_hint(self):
        ...
        # Test with requests
        analysis = self.analyzer.analyze_query("How to make HTTP requests with requests library")
...
class TestEnhancedSearchEngine:
    ...
    async def test_search_with_analysis(self):
        ...
        self.mock_embedding_service.embed_query = AsyncMock(return_value=[0.1, 0.2, 0.3])
