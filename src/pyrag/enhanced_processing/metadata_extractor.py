...
class MetadataExtractor:
    ...
    async def _extract_api_metadata(self, chunk: SemanticChunk, metadata: EnhancedMetadata):
        """Extract API-specific metadata."""
    ...
    async def _extract_content_analysis(self, chunk: SemanticChunk, metadata: EnhancedMetadata):
    ...
    async def _extract_relationships(self, chunk: SemanticChunk, metadata: EnhancedMetadata):
    ...
    async def _extract_context_info(self, chunk: SemanticChunk, metadata: EnhancedMetadata):
        """Extract context information."""
        ...
        metadata.version_compatibility = await self._extract_version_compatibility(chunk.content)
