...
class ContentTypeProcessor:
    ...
    async def process_code_block(self, code: str, language: str = "python") -> CodeChunk:
    ...
    def _highlight_syntax(self, code: str, language: str) -> str:
        ...
        if language.lower() == "python":
            ...
            # Highlight keywords
            keywords = ["def", "class", "import", "from", "as", "if", "else", "elif", "for", "while", "try", "except", "finally", "with", "return", "yield", "async", "await"]
    ...
    async def _check_deprecation(self, content: str) -> Optional[Dict[str, Any]]:
        ...
        deprecation_keywords = ["deprecated", "deprecation", "removed", "obsolete", "legacy"]
        ...
        if any(keyword in content.lower() for keyword in deprecation_keywords):
            ...
            try:
                ...
                return {"is_deprecated": True, "deprecation_message": "Deprecated", "replacement": None, "removal_version": None}
