...
class SemanticChunker:
    ...
    async def chunk_content(
        ...
        chunks = await self._create_semantic_chunks(
            content, semantic_boundaries, metadata, hierarchy_path
        )
    ...
    def _classify_section_type(self, section: str) -> str:
        ...
        if any(
            ...
            for word in ["overview", "introduction", "getting started"]
        ):
            return "overview"
    ...
    def _get_context_window(self, full_content: str, chunk_content: str) -> str:
        ...
        context_after = full_content[
            chunk_start + len(chunk_content) : chunk_start + len(chunk_content) + 200
        ]
