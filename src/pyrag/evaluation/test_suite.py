...
class TestSuite:
    ...
    def get_statistics(self) -> Dict[str, Any]:
        ...
        for tc in self.test_cases:
            category_counts[tc.category.value] = (
                category_counts.get(tc.category.value, 0) + 1
            )
            difficulty_counts[tc.difficulty.value] = (
                difficulty_counts.get(tc.difficulty.value, 0) + 1
            )
