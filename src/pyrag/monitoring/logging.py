...
class StructuredLogger:
    ...
    def get_log_entries(self, hours: int = 24) -> List[LogEntry]:
        ...
        return [entry for entry in self.log_entries if entry.timestamp > cutoff_time]
...
class LogAggregator:
    ...
    def search_logs(self, query: str, hours: int = 24) -> List[LogEntry]:
        ...
        for entry in recent_entries:
            if (
                ...
                or query_lower in entry.component.lower()
                or query_lower in (entry.operation or "").lower()
            ):
    ...
    def get_log_statistics(self, hours: int = 24) -> Dict[str, Any]:
        ...
        component_counts = {}
        for entry in recent_entries:
            component_counts[entry.component] = (
                component_counts.get(entry.component, 0) + 1
            )
