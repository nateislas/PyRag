...
class IntelligentSearchStrategy:
    ...
    def _analyze_query(self, query: str, query_context: Optional[Dict[str, Any]]) -> Dict[str, Any]:
        ...
        complexity_indicators = {
            ...
            "intermediate": ["how does", "difference between", "compare", "when to use"],
            "complex": ["why does", "performance", "optimization", "advanced", "custom"]
        }
        ...
        # Determine intent
        intent_indicators = {
            "api_reference": ["api", "class", "method", "function", "parameter", "return", "compare", "vs", "validation"],
            "tutorial": ["tutorial", "guide", "step by step", "getting started", "learn", "how to"],
            "examples": ["example", "code", "sample", "snippet", "demo"],
            "concepts": ["concept", "theory", "explanation", "understanding", "how it works", "what is"],
            "troubleshooting": ["error", "problem", "issue", "fix", "debug", "troubleshoot", "why does", "fail"]
        }
        ...
        return {
            ...
            "has_code": any(char in query for char in ["(", ")", "[", "]", "{", "}", "=", ">", "<"])
        }
    ...
    def get_collection_search_order(self, strategy_config: SearchStrategyConfig) -> List[str]:
        """Get ordered list of collections to search based on strategy."""
        
        # Sort collections by weight (highest first)
        sorted_collections = sorted(
            strategy_config.collection_weights.items(),
            key=lambda x: x[1],
            reverse=True
        )
    ...
    def calculate_metadata_boost(self, metadata: Dict[str, Any], strategy_config: SearchStrategyConfig) -> float:
