...
class QueryMetric(Base):
    ...
    )  # search, reference, deprecation_check, etc.
    ...
    user_satisfaction: Mapped[Optional[int]] = mapped_column(
    ...
    content_type_filter: Mapped[Optional[str]] = mapped_column(
...
class PerformanceMetric(Base):
    ...
    )  # response_time_p95, cache_hit_rate, etc.
    ...
    measurement_window: Mapped[Optional[str]] = mapped_column(
