...
from sqlalchemy import Column, DateTime, String, Text, Boolean, ForeignKey, Index
...
class Library(Base):
    ...
    # Relationships
    versions: Mapped[List["LibraryVersion"]] = relationship("LibraryVersion", back_populates="library", cascade="all, delete-orphan")
    compliance_status: Mapped[Optional["ComplianceStatus"]] = relationship("ComplianceStatus", back_populates="library", uselist=False, cascade="all, delete-orphan")
...
class LibraryVersion(Base):
    ...
    chunks: Mapped[List["DocumentChunk"]] = relationship("DocumentChunk", back_populates="library_version", cascade="all, delete-orphan")
    update_logs: Mapped[List["UpdateLog"]] = relationship("UpdateLog", back_populates="library_version", cascade="all, delete-orphan")
...
Index("idx_library_versions_library_version", LibraryVersion.library_id, LibraryVersion.version)
